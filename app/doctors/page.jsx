  ...
  const doctors = [
    {
      ...
      experience: "18+ Years",
      image: "https://i.postimg.cc/3xTkJ9gY/doctor1.jpg",
    ...
    },
    {
      ...
      experience: "15+ Years",
      image: "https://i.postimg.cc/0jG0V0jG/doctor2.jpg",
    ...
    },
    {
      ...
      experience: "20+ Years",
      image: "https://i.postimg.cc/6qD7Y7YQ/doctor3.jpg",  // এই লাইনটা ফিক্স করা হয়েছে
    ...
    },
    {
      ...
      experience: "12+ Years",
      image: "https://i.postimg.cc/9fW8W8W8/doctor4.jpg",
    ...
    },
    {
      ...
      experience: "16+ Years",
      image: "https://i.postimg.cc/3w3w3w3w/doctor5.jpg",
          ...
          {doctors.map((doctor, index) => (
            ...
            >
              ...
              <div className="relative h-80 overflow-hidden bg-gradient-to-b from-blue-100 to-white">
                ...
                {/* Specialty Badge */}
                <div className="absolute top-6 right-6 bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-5 py-2 rounded-full font-bold text-sm shadow-lg">
                  {doctor.specialty}
                </div>
              </div>
