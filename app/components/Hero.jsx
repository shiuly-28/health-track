// components/Hero.jsx → Final Bulletproof Version (18 Nov 2025)
...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-blue-50 to-cyan-50 overflow-hidden">
      <Swiper
        ...
        effect="fade"
        fadeEffect={{ crossFade: true }}   // Double render 100% fix
        speed={1400}
        allowTouchMove={false}             // Smoother auto slide
        className="h-screen"
      >
        {slides.map((slide) => (
              ...
              <div className="max-w-7xl mx-auto px-6 lg:px-8 h-full">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center h-full py-16 lg:py-0">
                  ...
                  <div className="order-1 lg:order-2 text-center lg:text-left space-y-6 lg:space-y-8">
                    {slide.emergency && (
                      <span className="inline-block px-5 py-2 bg-red-100 text-red-700 font-bold rounded-full text-sm animate-bounce">
                        Available 24/7
                      </span>
                    )}
      ...
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 lg:hidden">
        <a
          href="tel:+8801234567890"
          className="flex items-center gap-3 px-8 py-5 bg-red-600 hover:bg-red-700 text-white font-bold text-lg rounded-full shadow-2xl animate-pulse transition-all"
        >
          <Phone size={28} />
          Emergency Call
        </a>
